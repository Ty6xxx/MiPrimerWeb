...
// ========================
// Si ya tiene datos validos, arrancar el bot directo
// ========================
if (hasValidRustConfig()) {
  console.log('[Bot] Datos de Rust+ encontrados en .env, arrancando bot...\n');
  startBot();
} else {
